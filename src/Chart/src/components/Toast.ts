...
export default class Toast implements IToast<Element> {
                ...
                <div class="flex">
                    ...
                    <div class="ms-3 text-lg font-normal">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            ...
                            <div>
                                <button id="interactiveButtonNo" class="inline-flex justify-center w-full px-2 py-1.5 text-lg font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">${ ToastMessage.interactiveButtonNo }</button> 
                            </div>
                        </div>    
                    </div>
    ...
    #getSuccessToastString(message: string): string {
        return `
            <div id="${ this.id }" class="opacity-100 transition-opacity relative flex items-center w-full max-w-xs p-4 mb-4 ml-auto text-gray-500 bg-white rounded-lg shadow dark:text-white dark:bg-gray-800" role="alert">
