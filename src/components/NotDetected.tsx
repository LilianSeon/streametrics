...
export interface NotDetectedTextValueI18n {
    not_detected_message: string,
    not_detected_button: string
}

type NotDetectedProps = {
    notFoundTexts: NotDetectedTextValueI18n
}

const NotDetected: FC<NotDetectedProps> = ({ notFoundTexts }: NotDetectedProps) => {
        ...
        <p>
            ...
            <div className="flex flex-row justify-center items-center">
                <a href="#" onClick={ onClickLink } className="group inline-flex items-center justify-center shadow-lg hover:shadow px-3 py-2 text-base font-medium rounded-lg text-gray-100 bg-gray-600 hover:bg-gray-700 :hover:text-white">
                    ...
                    <span className="ms-2 w-full">{ notFoundTexts.not_detected_button } <span className="font-medium group-hover:text-blue-500 hover:underline">Twitch.tv</span></span>
