...
const NotFound: FC = () => {
    ...
    return(
        <p>
            <div className='flex flex-row justify-center items-center px-[6.5rem] pt-10 pb-2 text-base text-gray-200'>
                <p className="flex justify-center items-center">No live Twitch detected.</p>
            </div>
            <div className="flex flex-row justify-center items-center">
                <a href="#" onClick={ onClickLink } className="group inline-flex items-center justify-center shadow-lg hover:shadow px-3 py-2 text-base font-medium rounded-lg text-gray-100 bg-gray-600 hover:bg-gray-700 :hover:text-white">
                    ...
                    <span className="ms-2 w-full">Go to <span className="font-medium group-hover:text-blue-500 hover:underline">Twitch.tv</span></span>
